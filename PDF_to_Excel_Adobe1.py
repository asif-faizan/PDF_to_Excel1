...
# Load environment variables from pass.env file
load_dotenv('C://AgentControlCenter//PDF_to_Excel//pass1.env')

# Initialize the logger
filename = r"C://AgentControlCenter//PDF_to_Excel//logs//log_"+current_date+ ".txt"
...
if args.output:
    ...
    # If output path is not provided, use the directory of the input file
    OUTPUT_DIR = os.path.dirname(FILE_NAME)  # Get the directory of the input file


# Load environment variables from pass.env file
load_dotenv('pass1.env')
